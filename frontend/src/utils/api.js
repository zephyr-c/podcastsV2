...
const newMockServer = "https://5f4b07fa-471a-47fd-ba48-59793cf818ee.mock.pstmn.io/api/podcasts"
const backendAddress = "http://localhost:8000/api/podcasts/"
...
export async function deleteQuery(query){
    try {
        return await axios.delete(server + query.id + '/')
    }
    catch (error){
        errorLogger(error)
    }
